...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"URLやローカルHTMLから簡単に文字起こし"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"LP文字起こしツール"};
...
const entryFileName = "7G7OoW03.js";
