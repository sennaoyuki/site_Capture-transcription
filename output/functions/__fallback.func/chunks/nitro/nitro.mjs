...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "7649e641-8786-4e33-8e31-176246eff8cd",
...
const _lazy_Wp284P = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_Wp284P, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_Wp284P, lazy: true, middleware: false, method: undefined }
];
